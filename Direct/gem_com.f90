...
REAL(8) :: dx,dy,dz,pi,pi2,dt,dte,totvol,n0,n0e,tcurr,rmpp,rmaa,eprs
REAL(8) :: lx,ly,lz,xshape,yshape,zshape,pzcrit(5),pzcrite,encrit,tot_field_e,tot_joule,tot_joule1
INTEGER :: nm,nsm,kcnt,jcnt,ncurr,llk,mlk,onemd,iflr,iorb
integer :: izonal,ineq0,iflut,nlow,ntor0,mstart
REAL(8) :: cut,amp,beta,tor,amie,isg,rneu,rneui,emass,qel,mbeam,qbeam,teth,vexbsw,vparsw
REAL(8) :: c4,fradi,kxcut,kycut,bcut,ftrap,adwn,adwe,adwp,frmax
INTEGER :: iput,iget,idg,kzlook,ision,isiap,peritr,iadi,ipred,icorr,jpred,jcorr
REAL(8),DIMENSION(:,:),allocatable :: yyamp,yyre,yyim
complex(8),dimension(:,:),allocatable :: camp,campf
...
REAL(8),DIMENSION(:,:,:,:),allocatable :: dnidt,jpar,jpex,jpey,dti
REAL(8),DIMENSION(:,:,:),allocatable :: rho,jion,jionx,jiony
real(8),dimension(:,:,:),allocatable :: phi
real(8),dimension(:,:,:),allocatable :: drhodt,dnedt,dphidt,drhoidt
...
real(8),dimension(:,:,:),allocatable :: upar,upart,delte
real(8),dimension(:,:,:),allocatable :: upex,upey,upa0,den0,upazd,upa00,upa0t,den0apa
real(8),dimension(:,:),allocatable :: cfx,cfy,jac,bmag,bdgxcgy,bdgrzn,ggxdgy,ggy2,ggx
real(8),dimension(:),allocatable :: gn0e,gt0e,gt0i,avap 
real(8),dimension(:,:),allocatable :: gn0s

!          particle array declarations
REAL(8),DIMENSION(:,:),allocatable :: mu,xii,pzi,eki,z0i,u0i
REAL(8),DIMENSION(:,:),allocatable :: x2,y2,z2,u2
...
real(8),dimension(:),allocatable :: ipass, index
...
REAL(8),DIMENSION(:),allocatable :: rmsphi,rmsapa,avewe
REAL(8),DIMENSION(:,:),allocatable :: nos,avewi

!    flux diagnostics
REAL(8),DIMENSION(:),allocatable :: vol
REAL(8),DIMENSION(:,:),allocatable :: efle_es,efle_em,pfle_es,pfle_em
REAL(8),DIMENSION(:,:,:),allocatable :: pfl_es,pfl_em,efl_es,efl_em
REAL(8),DIMENSION(:,:),allocatable :: chii, chie, ddi
REAL(8),DIMENSION(:),allocatable :: achii, achie, addi
...
complex(8),dimension(:,:),allocatable :: aparhis,phihis
