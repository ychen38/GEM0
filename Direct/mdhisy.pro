...
plot, time, a4, title='', xtitle='!4x!l!3A!Nt', ytitle='rms(!4u!3)',linestyle=0, xrange=[0,600],yrange=[1e-6, 2e-1],/ylog
;oplot,time,a1,color=lan,linestyle=0

oplot,timep-25,a1p,color=lu,linestyle=0
oplot,timeq+25,a1q,color=lan,linestyle=0

;oplot,time,a1,color=2,linestyle=0
;oplot,time,a2,color=3,linestyle=0
;oplot,time,a3,color=4,linestyle=0
;oplot,time,a4,color=17,linestyle=0
;oplot,time,a5,color=6,linestyle=0
;oplot,time,a6,color=16,linestyle=0

;oplot,time,a7,color=11,linestyle=0
oplot,time,a8,color=hong,linestyle=0
;oplot,time,a11,color=11,linestyle=0
;oplot,time,a12,color=12,linestyle=0

xyouts,10,0.128,'n=14 single',color=lu
xyouts,10,0.512,'n=18 single',color=lan

;xyouts,10,0.128,'n=0'
;xyouts,10,0.064,'n=11',color=2
;xyouts,10,0.032,'n=12',color=3
;xyouts,10,0.016,'n=13',color=4
xyouts,10,0.064,'n=14',color=0
;xyouts,10,0.004,'n=15',color=6
;xyouts,10,0.002,'n=16',color=16
;xyouts,10,0.001,'n=17',color=11
xyouts,10,0.256,'n=18',color=hong
